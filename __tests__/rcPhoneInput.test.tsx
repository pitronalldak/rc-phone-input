...
describe("react telephone input", () => {
  ...
  it("mandatory existential crisis test", () => {
    rti = TestUtils.renderIntoDocument(React.createElement(RCPhoneInput, {}));
  ...
  it("should show the placeholder as passed in the prop", () => {
    ...
    const component = mount(<RCPhoneInput placeholder={placeholder} />);
  ...
  it("should re-render as empty once value prop becomes null", () => {
    const component = mount(<RCPhoneInput value="+12313123132" />);
  ...
  describe("validate number", () => {
    it("should format number", () => {
      ...
      expect(validateNumber(country, number)).to.equal(expectedFormattedNumber);
    });
