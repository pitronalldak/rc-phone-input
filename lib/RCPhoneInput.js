...
var RCPhoneInput = /** @class */ (function (_super) {
    ...
    function RCPhoneInput(props) {
        ...
        _this.getCountryPlaceholder = function (country) {
            ...
            return _this.getNumberFormat(country).replace(/\./gi, '1');
        };
    ...
    RCPhoneInput.prototype.componentDidMount = function () {
        var _this = this;
        var _a = this.props, onlyCountries = _a.onlyCountries, withIpLookup = _a.withIpLookup;
        if (withIpLookup) {
...
//# sourceMappingURL=RCPhoneInput.js.map