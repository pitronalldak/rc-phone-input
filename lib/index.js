...
var RCPhoneInput = /** @class */ (function (_super) {
    ...
    function RCPhoneInput(props) {
        ...
        _this.handleInput = function (event) {
            ...
            var formattedNumber = helpers_1.validateNumber(selectedCountry, event.target.value);
            _this.setState({
                formattedNumber: formattedNumber,
                number: event.target.value,
                freezeSelection: nextFreezeSelection
            });
            _this.handleChange({ country: selectedCountry, number: number, formattedNumber: formattedNumber });
        };
